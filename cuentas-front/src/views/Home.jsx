    ...
    <div className="row g-4">
     ...
     <div className="col-md-4">
      <Card ammount={8450.75} title={"Main Balance"} percent={5.2} />
        ...
        <div className="col-md-4">
        <CreditCard bank={"Bankio"} number={"1234 5678 9875 1237"} name={"Magdiel D"} date={"07/2025"} />
        </div>

      
        <div className="col-md-4">
        <Card ammount={5200} title={"Total income"}percent={8.5} />
        </div>

      
        <div className="col-md-4">
        <Card ammount={5200} title={"Total expenses"}percent={-3.5} />
        </div>
